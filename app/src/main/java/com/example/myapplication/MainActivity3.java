...
public class MainActivity3 extends AppCompatActivity{
    ...
    private MyService.MusicControl control;//声明MusicService中的音乐控制器

    private ServiceConnection connection = new ServiceConnection() { //声明服务连接
        @Override
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            control = (MyService.MusicControl) iBinder;//实例化音乐控制对象，即control。
        }
        @Override
    ...
    public void init(){
        ...
        Intent mintent = new Intent(MainActivity3.this,MyService.class);
