...
public class MainActivity4 extends AppCompatActivity{
    ...
    private MyService2.MusicControl control;//声明MusicService中的音乐控制器

    private ServiceConnection connection = new ServiceConnection() { //声明服务连接
        @Override
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            control = (MyService2.MusicControl) iBinder;//实例化音乐控制对象，即control。
        }
        @Override
    ...
    public void init(){
        ...
        Intent mintent = new Intent(MainActivity4.this,MyService2.class);
        bindService(mintent,connection,BIND_AUTO_CREATE);//建立意图中MainActivity4与MusicService两对象的服务连接
